...
document.querySelectorAll('.timeline-item, .project-card, .skill-category, .education-item, .achievement-item').forEach(el => {
    observer.observe(el);
});
...
// Add loading animation class to timeline items
...
document.addEventListener('DOMContentLoaded', () => {
    // Add initial reveal class to first section
